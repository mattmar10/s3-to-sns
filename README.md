...
This is a sample template for s3-to-sns - Below is a brief explanation of what we have generated for you:

```bash
.
├── README.MD                   <-- This instructions file
├── event.json                  <-- Sample S3 event.
├── S3-TO-SNS                 <-- Source code for a lambda function
...
```bash
sam logs -n HelloWorldFunction --stack-name s3-to-sns --tail
```
...
```bash
aws cloudformation delete-stack --stack-name s3-to-sns
```
